    ...
    <>
      ...
      <Column className=" col-span-9 pt-4 gap-4">
        ...
        <Project>
          ...
          <Column className="gap-3">
            <Project.Reason>
              ...
              <br /> - 서비스마다 서로 다른 개발 스택을 가지고 있어 컨텍스트 스위칭이 어려운 문제
            </Project.Reason>
            <Project.Purpose>
            ...
            <Project.Detail>
              ...
              <Project.DetailSubtitle>3. 버그를 줄이기 위한 Test Code 추가</Project.DetailSubtitle>
              <Project.DetailContent>
                - Unit test는 상태관리 및 개인적으로 개발된 Logic에 한하고, Integration Test 위주로
                작성
              </Project.DetailContent>
            </Project.Detail>
            <Project.Stacks>
        ...
        <Project>
          ...
          <Column className="gap-3">
            <Project.Reason>
              ...
              <br /> - 담당자의 잦은 변경과 명확한 책임자가 없어 발생한 문제에 대한 트래킹이 제대로
              이뤄지지 않음
            ...
            <Project.Detail>
              ...
              <Project.DetailContent>
                PostgreSQL
                <br /> 당시에 떠오르던 DB DB레벨에서 지원하는 함수가 많았고, Array 형태의 데이터를
                지원했음
              </Project.DetailContent>
              <Project.DetailContent>
                typeORM
                <br /> Sequalize라는 JS 생태계에서의 전통적인 ORM이 있었지만 TypeScript와의 궁합이
                좋지 않음 (추가 configuration이 다수 필요)
              ...
              <Project.DetailSubtitle>3. API 서버 초기 디렉토리 구조 결정</Project.DetailSubtitle>
        ...
        <Project>
          ...
          <Column className="gap-3">
            <Project.Reason>
              - 적은 개발 인원으로 많은 서비스를 배포하고 관리하다 보니 기술 부채가 많이 쌓여있었고,
              조직이 갑자기 커졌을 때가 우려됨
            ...
            <Project.Detail>
              ...
              <Project.DetailSubtitle>
                2. 개발일 대신 각종 회의들이 많은 월요일로 날짜를 지정해 서비스 일정에 크게 지장을
                주지 않도록 함
              </Project.DetailSubtitle>
              <Project.DetailSubtitle>
        ...
        <Project>
          ...
          <Column className="gap-3">
            <Project.Reason>
              - 당시에 팀의 개발자가 점점 늘어나는 추세였고, 각자의 코드 스타일이나 우리 팀의 개발
              스택을 일일이 알려주기 어려운 상황이었음
              <br /> - 또한 대부분의 개발자가 신입 개발자이므로 온보딩을 효과적으로 진행할 필요가
              있었음.
          ...
          <Column className="gap-3">
            ...
            <Project.Detail>
              ...
              <Project.DetailContent>
                ...
                <br /> - 문제를 명확히 하고 해당 문제를 개선할 수 있는 구체적인 방안(Action plan)에
                대해 충분히 회의
                <br /> - 구체적인 개선점과 비즈니스 목표에 맞는 스프린트 목표를 세워서 다음 스프린트
                진행
              </Project.DetailContent>
              <Project.DetailSubtitle>2. 데일리 및 분기별 1:1 면담</Project.DetailSubtitle>
              <Project.DetailSubtitle>
                3. 개발팀의 업무관리가 Jira에서 Notion으로 넘어오면서, Notion으로 스프린트를 관리할
                수 있도록 시스템 개선
              </Project.DetailSubtitle>
            </Project.Detail>
      ...
      <Column className=" col-span-full">
        📚 매새일: 매일매일 새로워지는 일상 독서모임 | 2023.01 ~ - 책을 통해서 일상을 바꿔보자는
        취지로 매달 진행 - 돌아가면서 한 권씩 책을 선정해 모두가 읽고 얻은 인사이트를 만나서 공유
        ### 🔁 Loopback 개발자 회고 모임 | 2022 ~ - 반기 / 매년 마다 한 번씩 오프라인으로 모여서
        진행하는 개발자 회고 모임 - 각자의 시간을 스스로, 그리고 서로가 돌아보면서 동기부여의 시간을
        갖기 위해 진행 시작 ### 🎤 24절기톡 인사이트 공유 스피치 모임 | 2022.03 ~ - 24절기마다
        돌아가면서 각자 발표하고 싶은 주제로 준비해 발표 - 서로 모르던 분야에 대한 지식 공유, 본인의
        발표 주제에 대해 한 번 더 깊게 공부하는 계기, 발표 실력 향상 ---
      </Column>
